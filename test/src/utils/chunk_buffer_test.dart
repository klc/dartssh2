...
void main() {
  group('ChunkBuffer', () {
    ...
    group('copy-vs-view semantics', () {
      test('add() copies its input: mutating the source afterwards does '
      ...
      test('consume() returns a COPY: mutating it does not affect the '
      ...
      test('view() and consumeView() return a VIEW: mutating the returned '
